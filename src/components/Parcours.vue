  ...
  <main>
    <div class="parcours">
      ...
      <div class="contain-parcours">
        <div class="citation">
          <p>
            "C'est ma curiosité, mon envie d'évoluer, et mon travail qui me conduit vers la recherche expressive et les compositions graphiques."
          </p>
        </div>
...
<style scoped>
/* 🌟 Version Desktop (Ton CSS est conservé) */
.parcours {
  padding: 20px;
}
